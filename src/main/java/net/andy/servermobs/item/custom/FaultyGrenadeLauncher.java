...
public class FaultyGrenadeLauncher extends RangedWeaponItem {
    public static final int TICKS_PER_SECOND = 10;
    public static final int RANGE = 15;

    public FaultyGrenadeLauncher(Settings settings) {
        super(settings);
    }
    ...
    public void onStoppedUsing(ItemStack stack, World world, LivingEntity user, int remainingUseTicks) {
        ...
        float f = FaultyGrenadeLauncher.getPullProgress(i);
        if ((double)f < 0.1) {
            return;
        }
        List<ItemStack> list = FaultyGrenadeLauncher.load(stack, itemStack, playerEntity);
        ...
        world.createExplosion(null, playerEntity.getX(), playerEntity.getY(), playerEntity.getZ(), 0.1F, World.ExplosionSourceType.NONE);
