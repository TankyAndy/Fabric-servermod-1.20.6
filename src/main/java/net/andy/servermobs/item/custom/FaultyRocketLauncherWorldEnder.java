...
public class FaultyRocketLauncherWorldEnder extends RangedWeaponItem {
    public static final int TICKS_PER_SECOND = 10;
    public static final int RANGE = 15;

    public FaultyRocketLauncherWorldEnder(Settings settings) {
        super(settings);
    }
    ...
    public void onStoppedUsing(ItemStack stack, World world, LivingEntity user, int remainingUseTicks) {
        ...
        float f = FaultyRocketLauncherWorldEnder.getPullProgress(i);
        if ((double)f < 0.1) {
            return;
        }
        List<ItemStack> list = FaultyRocketLauncherWorldEnder.load(stack, itemStack, playerEntity);
        ...
        world.createExplosion(null, playerEntity.getX(), playerEntity.getY(), playerEntity.getZ(), 100000.0F, World.ExplosionSourceType.BLOCK);
